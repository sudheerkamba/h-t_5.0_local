...
@Entity(name="booking_details_1S")

public class TicketModel {
	
	private String flightNo;
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE,generator = "pnrNumber")
	...
	private int seatsCount;
	  ...
	  @JoinColumn(name="pnrNumber") private List<Passengers> passengers=new
